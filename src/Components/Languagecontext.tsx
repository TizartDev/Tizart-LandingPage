...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  "hero.title2":    "إلى",
  "hero.teal":      "واقع!",
  "hero.sub":       "تيزارت — منصة لبناء الستارتاب",
  "hero.desc":      "تيزارت وكالة رقمية عصرية متخصصة في تطوير المواقع والتطبيقات، التصميم، والذكاء الاصطناعي. نعاونوا الشركات الناشئة باش يحوّلو أفكارهم لمنتجات رقمية قوية.",
  "hero.cta1":      "ابدا دوكا →",
  "hero.cta2":      "شوف المشاريع",
  "hero.stat1.val": "+50",
  "hero.stat1.lbl": "مشروع مكمل",
  "hero.stat2.val": "98%",
  "hero.stat2.lbl": "رضا الزبائن",
  "hero.stat3.val": "4×",
  "hero.stat3.lbl": "متوسط الأرباح",

  // About
  "about.eyebrow":  "علينا",
  "about.title1":   "شكون",
  "about.title2":   "حنا؟",
  "about.tagline":  "فريق من المطورين والمصممين والاستراتيجيين نحولو الأفكار لمنتجات رقمية عالمية.",
  "about.kicker":   "قصتنا",
  "about.h2.1":     "خبرة رقمية،",
  "about.h2.2":     "ونتايج حقيقية.",
  "about.desc":     "وكالة رقمية متخصصة في بناء مواقع وتطبيقات عصرية. هدفنا نعاونوا الشركات تكبر باستعمال التكنولوجيا والتصميم. كل مشروع نخدموه عندو هدف — ماشي غير شكل.",
  "about.stat1.v":  "+50", "about.stat1.l": "مشروع مكمل",
  "about.stat2.v":  "+30", "about.stat2.l": "زبون راضي",
  "about.stat3.v":  "+3",  "about.stat3.l": "سنين خبرة",
  "about.grid.title1": "خدماتنا", "about.grid.title2": "",
  "about.exp1.title": "تطوير الويب",
  "about.exp1.desc":  "تطبيقات ويب عصرية، سريعة وقابلة للتوسع مبنية بأحدث التقنيات.",
  "about.exp2.title": "تطبيقات الموبايل",
  "about.exp2.desc":  "تجارب موبايل تخدم في كل الأجهزة وكأنها أصلية.",
  "about.exp3.title": "تصميم UI/UX",
  "about.exp3.desc":  "واجهات جميلة وسهلة الاستعمال يحبها المستخدم.",
  "about.exp4.title": "حلول الذكاء الاصطناعي",
  "about.exp4.desc":  "حلول ذكية بالأتمتة باش تطوّر منتجك.",

  // Services
  "sv.eyebrow":    "واش نقدمو",
  "sv.title1":     "خدماتنا",
  "sv.title2":     "",
  "sv.tagline":    "نصممو ونطورو مواقع وتطبيقات عصرية حسب احتياجاتك.",
  "sv.s1.title":   "تطوير الويب",
  "sv.s1.sub":     "حلول متكاملة",
  "sv.s1.desc":    "نطورو تطبيقات ويب قوية بتقنيات حديثة كيما React و Node.js — آمنة وقابلة للتوسع.",
  "sv.s1.f1": "React / Next.js", "sv.s1.f2": "Node.js و APIs", "sv.s1.f3": "تصميم قواعد البيانات", "sv.s1.f4": "النشر السحابي",
  "sv.s2.title":   "تطوير الموبايل",
  "sv.s2.sub":     "iOS و Android",
  "sv.s2.desc":    "نصنعو تطبيقات موبايل سلسة تخدم في iOS و Android باستخدام React Native.",
  "sv.s2.f1": "React Native", "sv.s2.f2": "متعدد المنصات", "sv.s2.f3": "إشعارات فورية", "sv.s2.f4": "جاهز للنشر",
  "sv.s3.title":   "تصميم UI/UX",
  "sv.s3.sub":     "التجربة والواجهة",
  "sv.s3.desc":    "نصممو واجهات نظيفة وسهلة مع تركيز على تجربة المستخدم.",
  "sv.s3.f1": "نماذج Figma", "sv.s3.f2": "Design Systems", "sv.s3.f3": "دراسة المستخدم", "sv.s3.f4": "تصميم متجاوب",
  "sv.learn":      "شوف أكثر",
  "sv.banner.title1": "عندك مشروع؟",
  "sv.banner.title2": "خلينا نبداوه.",
  "sv.banner.sub": "احكيلنا على فكرتك ونحوّلوها لمنتج رقمي قوي — سريع، جميل، وقابل للتوسع.",
  "sv.banner.btn": "ابدا مشروع",

  // Contact
  "ct.eyebrow":  "اتصل بينا",
  "ct.title1":   "كلمنا",
  "ct.title2":   "",
  "ct.tagline":  "خلينا نهضرو على مشروعك ونحوّلو فكرتك لواقع.",
  "ct.ch.title": "لقانا وين ما تكون",
  "ct.ch.sub":   "اختار الطريقة اللي تناسبك — حنا متواجدين في كل المنصات.",
  "ct.email.hint": "نردو خلال 24 ساعة",
  "ct.phone.hint": "الاثنين–الجمعة، 9ص–6م",
  "ct.ig.hint":    "راسلنا في أي وقت",
  "ct.fb.hint":    "راسلنا على ماسنجر",
  "ct.form.kicker": "ابعت رسالة",
  "ct.form.title1": "ابدا",
  "ct.form.title2": "محادثة",
  "ct.form.sub":    "عمر الفورم ونرجعو لك بسرعة.",
  "ct.name":       "الاسم",
  "ct.name.ph":    "اسمك",
  "ct.email":      "الإيميل",
  "ct.email.ph":   "example@email.com",
  "ct.msg":        "الرسالة",
  "ct.msg.ph":     "احكيلنا على مشروعك...",
  "ct.send":       "ابعت",
  "ct.sending":    "راه يتبعت…",
  "ct.success.title1": "الرسالة",
  "ct.success.title2": "وصلت!",
  "ct.success.sub": "شكراً على تواصلك. نرجعو لك خلال 24 ساعة.",

  // Projects
  "pj.eyebrow":  "المشاريع",
  "pj.title1":   "أعمالنا",
  "pj.title2":   "المختارة",
  "pj.tagline":  "بعض المشاريع اللي خدمناهم مع زبائننا.",
  "pj.featured": "مشروع مميز",
  "pj.client":   "الزبون",
  "pj.year":     "السنة",
  "pj.role":     "الدور",
  "pj.live":     "شوف المشروع",
  "pj.github":   "GitHub",
  "pj.p1.title": "منصة سياحية",
  "pj.p1.desc":  "اكتشف الطبيعة بتجارب سفر تحافظ على البيئة وتدعم المجتمعات المحلية.",
  "pj.p1.role":  "Full Stack",
  "pj.p2.title": "متجر إلكتروني للأزياء",
  "pj.p2.desc":  "متجر متكامل فيه منتجات، سلة، دفع آمن ولوحة تحكم.",
  "pj.p2.role":  "Full Stack",
  "pj.p3.title": "مولد CV بالذكاء الاصطناعي",
  "pj.p3.desc":  "أداة ذكية تنشئ سير ذاتية احترافية في ثواني.",
  "pj.p3.role":  "Frontend",

  // Footer
  "ft.brand.desc": "تيزارت وكالة رقمية تساعد الشركات الناشئة تبني منتجات رقمية قوية وقابلة للتوسع.",
  "ft.nav":        "التنقل",
  "ft.services":   "الخدمات",
  "ft.contact":    "اتصل بينا",
  "ft.cta.eyebrow": "ابدا مشروع",
  "ft.cta.title1":  "عندك فكرة؟",
  "ft.cta.title2":  "خلينا نحققوها مع بعض.",
  "ft.cta.sub":     "ابعتلنا رسالة ونرجعو لك خلال 24 ساعة.",
  "ft.cta.btn":     "اتصل بينا",
  "ft.copy":        "وكالة تيزارت",
  "ft.madein":      "صُنع بكل فخر في الجزائر",
}
